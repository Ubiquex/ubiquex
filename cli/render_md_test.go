...
// blueprint_calls entry, same resolve/accept/ship pipeline) -- asserting
// on markdown's own grouping heading instead of the D2 dashed container,
// proving --md reuses the IDENTICAL grouping basis
