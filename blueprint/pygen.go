...
func renderPyBindings(blueprintName string, resources []*pyResource) string {
	var b strings.Builder
	...
	for _, pr := range resources {
		...
		b.WriteString("    },\n")
		// blueprint_name (UBI-225) is the SAME raw name renderPyFunction's
		// own generated wrapper function passes to push_blueprint_source --
