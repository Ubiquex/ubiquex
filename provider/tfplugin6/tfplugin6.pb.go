...
//
// Vendored verbatim from github.com/hashicorp/terraform-plugin-go
// (tfprotov6/internal/tfplugin6/tfplugin6.proto @ v0.31.0), per that file's own
// instruction to copy the definition into consuming codebases. Only the
// go_package option below has been changed.
//
...
const file_tfplugin6_proto_rawDesc = "" +
	...
	"\fStopProvider\x12\x1f.tfplugin6.StopProvider.Request\x1a .tfplugin6.StopProvider.ResponseB3Z1github.com/ubiquex/ubiquex-cli/provider/tfplugin6b\x06proto3"
