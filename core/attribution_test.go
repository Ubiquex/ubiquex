...
func TestAttributeDrift_SingleMatch(t *testing.T) {
	...
	sources := AttributeDrift(context.Background(), lookup, Address{Stack: "s", Type: "aws_s3_bucket", Name: "ubx-states"}, observed, since, until)
...
func TestAttributeDrift_MultipleMatches_NewestFirst(t *testing.T) {
	...
	sources := AttributeDrift(context.Background(), lookup, Address{Stack: "s", Type: "aws_iam_role", Name: "my-role"}, observed, since, until)
...
func TestAttributeDrift_NoMatchingEvent(t *testing.T) {
	...
	sources := AttributeDrift(context.Background(), lookup, Address{Stack: "s", Type: "aws_sqs_queue", Name: "my-queue"}, observed, since, until)
...
func TestAttributeDrift_NotLogged_APIError(t *testing.T) {
	...
	sources := AttributeDrift(context.Background(), lookup, Address{Stack: "s", Type: "aws_s3_bucket", Name: "my-bucket"}, observed, since, until)
...
func TestAttributeDrift_FallsBackFromIDToARN(t *testing.T) {
	...
	sources := AttributeDrift(context.Background(), lookup, Address{Stack: "s", Type: "aws_lambda_function", Name: "fn-name"}, observed, since, until)
